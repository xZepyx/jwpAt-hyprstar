...
PopupWindow {
    ...
    // ===== Anchoring (same style as WidgetPanel/PowerMenu) =====
    ...
    Connections {
        ...
        function onAnchoring() {
            ...
            // windowX = anchorWidth - pop.width + shadowPad
            pop.anchor.rect.x = Math.round(pop.anchorItem.width - pop.width + pop.shadowPad)

            // Under the button, with gap, and subtract shadowPad so the card starts at "gap"
    ...
    Item {
        ...
        Rectangle {
            ...
            // ===== CONTENT (your old panel content, unchanged) =====
            ColumnLayout {
                anchors.fill: parent
                anchors.margins: 12
                spacing: 12
